...
class Ui_MainWindow(object):
    ...
    def openClick(self, filename):
        ...
        num_points = len(self.Canvas.features)
        if num_points >= 0:
            info_box = QMessageBox()
            info_box.setWindowTitle("Information")
            info_box.setIcon(QMessageBox.Icon.Information)  # Use information icon
            info_box.setText(f"Successfully loaded {num_points} points.")
            info_box.exec()
        else:
            warning_box = QMessageBox()
            warning_box.setWindowTitle("Warning")
            warning_box.setIcon(QMessageBox.Icon.Warning)
            warning_box.setText("No points loaded.")
            warning_box.exec()
    ...
    def analyzeExpositionClick(self):
        ...
        dtm_exposition = a.analyzeDTMExposition(dt)
        
        #Set results
        self.Canvas.setDTMExposition(dtm_exposition)
    ...
    def viewExpositionClick(self):
        #Enable/disable drawing
        self.Canvas.setViewExposition(self.actionExposition.isChecked())
